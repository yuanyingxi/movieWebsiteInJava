...
public class ExcelImportServiceImpl implements ExcelImportService {
    ...
    private Movie parseMovie(Row row) throws ExcelParseException{
        ...
        try{
            ...
            movie.setCoverUrl("http://aa286d75.natappfree.cc/api/MovieCover/"+getCellStringValue(row, 0)+".jpg"); // 封面URL
            ...
            movie.setUrl(isVip==1?"http://aa286d75.natappfree.cc/api/video/AveMujica.mp4":"http://aa286d75.natappfree.cc/api/video/MyGo.mp4");
